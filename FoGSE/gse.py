...
if __name__=="__main__":
    ...
    lay.addWidget(f0, 1, 0, 2, 2)
    lay.addWidget(f1, 2, 1, 2, 2)
    lay.addWidget(f2, 2, 3, 2, 2)
    lay.addWidget(f3, 1, 4, 2, 2)
    lay.addWidget(f4, 0, 3, 2, 2)
    lay.addWidget(f5, 0, 1, 2, 2)
    lay.addWidget(f6, 1, 2, 2, 2)
